...
HD_PWD='C:/Users/markr/Documents/configurable_multiplier/configurable_multiplier.runs/clk_mod_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mod.tcl
